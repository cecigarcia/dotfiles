...
" someone is forcing the backgroun to dark, so this has to be forced :(
" if &background ==# 'light'
...
let s:p.normal.left = [ [ s:base03, s:blue ], [ s:blue, s:base02 ], [s:orange, s:base02] ]
let s:p.normal.right = [ [ s:base03, s:base1 ], [ s:base03, s:base00 ] ]
let s:p.normal.project = [ [ s:base00, s:base02 ]]
let s:p.inactive.right = [ [ s:base03, s:base00 ], [ s:base0, s:base02 ] ]
let s:p.inactive.left =  [ [ s:base0, s:base02 ], [ s:base0, s:base02 ], [s:orange, s:base02] ]
let s:p.insert.left = [ [ s:base03, s:green ], [ s:green, s:base02 ], [s:orange, s:base02] ]
let s:p.replace.left = [ [ s:base03, s:red ], [ s:red, s:base02 ], [s:orange, s:base02] ]
let s:p.visual.left = [ [ s:base03, s:magenta ], [ s:magenta, s:base02 ], [s:orange, s:base02] ]
...
let g:lightline#colorscheme#asou_light#palette = lightline#colorscheme#flatten(s:p)
